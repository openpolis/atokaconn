...
def search(
    filters: str = typer.Argument(
        None,
        help="Filters as url parameters, ex: ageMax=20&gender=F. "
        "See: https://developers.atoka.io/v2/people.html#people_general"
    ),
    count: bool = typer.Option(
        False,
        help="Get just the number of people matched. If not set, then items are shown"
    ),
    ...
    ordering: str = typer.Option(
        ...
        "See: https://developers.atoka.io/v2/people.html#people_pagination"
    ),
    packages: str = typer.Option(
        None, help="The packages to show in results items. "
        "See: https://developers.atoka.io/v2/people.html#people_packages"
    )
):
    """Search persons.
    """
...
def bulk_ids(
    ...
    This means that something like this is possible:
        ...
        cat ids.csv | atokaconn --verbose --token=2f8d8506177a4772c817f98aa3be0d57 people bulk-ids
    ...
    result = conn.get_response_from_ids(
        ids=ids_list, item_type='people', ids_field_name=ids_type,
